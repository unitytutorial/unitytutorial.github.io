...
学习资料:
  * [相关代码](https://github.com/unitytutorial/tutorials/blob/master/tkinterTUT/tk5_radiobutton.py){:target="_blank"}
...
再补充一下 Tkinter 的[必备步骤](https://github.com/unitytutorial/tutorials/blob/master/tkinterTUT/tk5_radiobutton.py){:target="_blank"},
整个框架的全部代码就完美了.
