...
学习资料:
  * [全部代码](https://github.com/unitytutorial/Reinforcement-learning-with-tensorflow/tree/master/contents/5.3_Dueling_DQN){:target="_blank"}
...
下面的修改都是基于我之前写的 [DQN 代码](https://github.com/unitytutorial/tutorials/blob/master/Reinforcement_learning_TUT/5_Deep_Q_Network/RL_brain.py){:target="_blank"}.
这次修改的部分比较少. 我们把它们写在一块. 如果想直接看全部代码, [请戳这里](https://github.com/unitytutorial/Reinforcement-learning-with-tensorflow/tree/master/contents/5.3_Dueling_DQN){:target="_blank"}.
...
对比的代码不在这里呈现, 如果想观看对比的详细代码, 请去往我的 [Github](https://github.com/unitytutorial/tutorials/blob/master/Reinforcement_learning_TUT/5.3_Dueling_DQN/run_Pendulum.py){:target="_blank"}.
