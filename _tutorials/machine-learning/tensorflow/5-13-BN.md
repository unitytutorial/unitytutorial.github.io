...
学习资料:
  ...
  * [本节相关代码](https://github.com/unitytutorial/tutorials/blob/master/tensorflowTUT/tf23_BN/tf23_BN.py){:target="_blank"}
...
代码中的 `plot_his()` 不会在这里讲解, 请自己在[全套代码中查看](https://github.com/unitytutorial/tutorials/blob/master/tensorflowTUT/tf23_BN/tf23_BN.py){:target="_blank"}.
