...
学习资料:
  * [本节的全部代码](https://github.com/unitytutorial/Evolutionary-Algorithm/blob/master/tutorial-contents/Genetic%20Algorithm/Match%20Phrase.py){:target="_blank"}
...
所以不会再详细说明了. 你也可以去我的 [github 看全部代码](https://github.com/unitytutorial/Evolutionary-Algorithm/blob/master/tutorial-contents/Genetic%20Algorithm/Match%20Phrase.py){:target="_blank"}.
...
有了上面定义的这些功能, 再将其他的[小部分](https://github.com/unitytutorial/Evolutionary-Algorithm/blob/master/tutorial-contents/Genetic%20Algorithm/Match%20Phrase.py){:target="_blank"}补全.
...
赶紧试试这套github的[全部代码](https://github.com/unitytutorial/Evolutionary-Algorithm/blob/master/tutorial-contents/Genetic%20Algorithm/Match%20Phrase.py){:target="_blank"}.
