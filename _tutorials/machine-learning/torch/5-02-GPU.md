...
学习资料:
  * [本节的全部代码](https://github.com/unitytutorial/PyTorch-Tutorial/blob/master/tutorial-contents/502_GPU.py){:target="_blank"}
...
这份 GPU 的代码是依据[之前这份CNN](https://github.com/unitytutorial/PyTorch-Tutorial/blob/master/tutorial-contents/401_CNN.py){:target="_blank"}的代码修改的.
...
所以这也就是在我 [github 代码](https://github.com/unitytutorial/PyTorch-Tutorial/blob/master/tutorial-contents/502_GPU.py){:target="_blank"} 中的每一步的意义啦.
