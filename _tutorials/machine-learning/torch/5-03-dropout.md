...
学习资料:
  * [本节的全部代码](https://github.com/unitytutorial/PyTorch-Tutorial/blob/master/tutorial-contents/503_dropout.py){:target="_blank"}
  * [Tensorflow 的 50行 Dropout 代码](https://github.com/unitytutorial/Tensorflow-Tutorial/blob/master/tutorial-contents/501_dropout.py){:target="_blank"}
...
所以这也就是在我 [github 代码](https://github.com/unitytutorial/PyTorch-Tutorial/blob/master/tutorial-contents/503_dropout.py){:target="_blank"} 中的每一步的意义啦.
